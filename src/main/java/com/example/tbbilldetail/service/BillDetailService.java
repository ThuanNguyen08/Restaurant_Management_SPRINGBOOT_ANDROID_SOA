...
import com.example.tbbilldetail.config.BadRequestException;
import com.example.tbbilldetail.config.ResourceNotFoundException;
import com.example.tbbilldetail.entities.BillDetail;
import com.example.tbbilldetail.repository.BillDetailRepository;
...
public class BillDetailService {
    ...
    public BillDetail createBillDetail(BillDetail billDetail, String token) {
        try {
            ...
            Optional<BillDetail> existingDetail = billDetailRepository
                .findByBillIDAndFoodID(billDetail.getBillID(), billDetail.getFoodID());
    ...
    public BillDetail updateBillDetail(Integer billId, Integer foodId, Integer newQuantity) {
        BillDetail detail = billDetailRepository.findByBillIDAndFoodID(billId, foodId)
