package com.example.FoodAndDmFood.controller;
...
import com.example.FoodAndDmFood.service.DmFoodService;
import com.example.FoodAndDmFood.service.FoodService;
import com.example.FoodAndDmFood.service.RequestOtherPortService;
...
public class FoodController {
    ...
    public ResponseEntity<?> addFood(@RequestHeader("Authorization") String token, @RequestBody Food food) {
        try {
            ...
            String categoryName = dmFoodService.getById(food.getDmFoodID());
